...
export default function Sidebar({ musics, onMusicClick, onAddMusic, onHomeClick, onBrowseClick, isSidebarVisible }) {
  ...
  return (
    <aside className={sidebarClasses}>
      <nav className="space-y-2">
        ...
        <button onClick={onBrowseClick} className='hover:underline cursor-pointer bg-secondary p-2 my-2 hover:bg-tertiary rounded-full px-18 flex items-center w-full gap-2 transition-transform duration-200 hover:scale-105'>
          <TbZoom /> Browse
        </button>
      </nav>
      ...
      <div className="mt-4 pt-4 border-t border-gray-800 flex-grow flex flex-col min-h-0">
        <div className="flex justify-between items-center mb-2">
          <h2 className="text-xl font-bold flex items-center gap-2"><CgAlbum /> Your Library </h2>
